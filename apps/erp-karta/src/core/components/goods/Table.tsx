...
const TableGoods: React.FunctionComponent<Props> = ({
  typeId,
  data,
  loading,
  refetch,
  ...
  const [selected, setSelected] = React.useState<z.infer<typeof GoodsType> | null>(null)
...
export default memo(TableGoods)
